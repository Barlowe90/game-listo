...
@Disabled("Plantilla de test para GrupoId: deshabilitada hasta implementar el VO")
@DisplayName("GrupoId - Plantilla de tests")
class GrupoIdTest {

  @Test
  @DisplayName("of(valid) debe crear instancia y mantener valor")
  void of_debeCrearConValorValido() {
    // TODO: implementar cuando se cree GrupoId
  }
