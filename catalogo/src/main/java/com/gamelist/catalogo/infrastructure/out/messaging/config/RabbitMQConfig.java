...
public class RabbitMQConfig {
  ...
  public static final String QUEUE_NAME =
      "catalogos.queue"; // el nombre de la cola que crea el servicio
  ...
  public Queue queue() {
    return QueueBuilder.durable(QUEUE_NAME)
        ...
        .withArgument("x-dead-letter-routing-key", "dlq.catalogos")
  ...
  public Binding dlqBinding(Queue deadLetterQueue, TopicExchange dlqExchange) {
    return BindingBuilder.bind(deadLetterQueue).to(dlqExchange).with("dlq.catalogos");
  }
