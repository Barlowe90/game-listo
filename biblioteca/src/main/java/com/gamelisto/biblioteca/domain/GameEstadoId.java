...
public final class GameEstadoId {
    ...
    private GameEstadoId(UUID value) {
        if (value == null) {
            throw new IllegalArgumentException("El id de GameEstado no puede ser nulo");
        }
        this.value = value;
    }
    ...
    public static GameEstadoId fromString(String value) {
        if (value == null || value.trim().isEmpty()) {
            throw new IllegalArgumentException("El id de GameEstado no puede ser nulo o vacío");
        }
        try {
