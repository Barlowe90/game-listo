...
public class GameEstado {
  ...
  private GameEstado(
    ...
    if (rating == null) throw new DomainException("rating no puede ser nulo");
  ...
  public static GameEstado create(
      UsuarioId usuarioRefId, GameId gameRefId, Estado estado, Rating rating) {
    return new GameEstado(GameEstadoId.generate(), usuarioRefId, gameRefId, estado, rating);
  }

  public static GameEstado create(
      java.util.UUID usuarioRefId, Long gameRefId, Estado estado, double rating) {
  ...
  public static GameEstado reconstitute(
    ...
    return reconstitute(
        id, UsuarioId.of(usuarioRefId), GameId.of(gameRefId), estado, Rating.of(rating));
  }
