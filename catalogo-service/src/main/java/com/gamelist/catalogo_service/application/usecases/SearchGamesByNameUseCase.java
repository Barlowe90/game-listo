 ...
 * microservicio de búsqueda (search-service). Este caso de uso ya no invoca métodos como
 * findByNameContaining y lanzará UnsupportedOperationException para que el llamador use el servicio
 * de búsqueda apropiado.
 */
@Service
