...
import com.gamelisto.usuarios_service.domain.events.UsuarioCreadoEvent;
...
public class CrearUsuarioUseCase {
    ...
    public CrearUsuarioUseCase(RepositorioUsuarios repositorioUsuarios, IEventosPublisher eventosPublisher, PasswordEncoder passwordEncoder) {
