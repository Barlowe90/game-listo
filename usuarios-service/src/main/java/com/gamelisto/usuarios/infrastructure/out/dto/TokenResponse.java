...
public record TokenResponse(
    @Schema(description = "Token (JWT para access, UUID para refresh)", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...") String token,
    @Schema(description = "Fecha de expiración del token (ISO 8601)", example = "2026-01-30T18:15:00Z") Instant expiresAt) {
