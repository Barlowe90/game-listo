package com.gamelisto.usuarios_service.infrastructure.persistence;
...
class RepositorioUsuariosIntegrationTest {
    ...
    void debeBuscarPorEstado() {
        // Arrange
        Usuario usuarioActivo = Usuario.create(
            Username.of("activo"),
            Email.of("activo@example.com"),
        ...
        Usuario usuarioPendiente = Usuario.create(
        ...
        List<Usuario> pendientes = repositorioUsuarios.findByStatus(EstadoUsuario.PENDIENTE_DE_VERIFICACION);
    ...
    void debeBuscarPorEstadoYNotificaciones() {
        ...
        // Act
        List<Usuario> conNotificaciones = repositorioUsuarios.findByStatusAndNotificationsActive(
            EstadoUsuario.ACTIVO, true
        );
        List<Usuario> sinNotificaciones = repositorioUsuarios.findByStatusAndNotificationsActive(
    ...
    void debeRetornarVacioSiNoExisteEmail() {
        // Act
        Optional<Usuario> noEncontrado = repositorioUsuarios.findByEmail(Email.of("noexiste@example.com"));
