...
class ResendEmailServiceTest {
  ...
  @Test
  @DisplayName("Debe lanzar EmailSendingException cuando API key es inválido")
  ...
  @Test
  @DisplayName("Debe lanzar EmailSendingException cuando falla envío de reset password")
  ...
  void debeAceptarDiferentesFormatosDeEmailValidos() {
    ...
    for (String email : validEmails) {
      assertThatThrownBy(() -> emailService.sendVerificationEmail(email, "user", "token"))
          .isInstanceOf(EmailSendingException.class); // Falla por API key, no por validación
    }
  }
  ...
  void debeManejarUsernameConCaracteresEspeciales() {
    ...
    assertThatThrownBy(
        ...
        .isInstanceOf(EmailSendingException.class); // Solo falla por API key
  }
  ...
  @Test
  @DisplayName("Debe propagar excepción de Resend como EmailSendingException")
