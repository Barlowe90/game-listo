...
class UsuarioMapperTest {
    ...
    void debeRealizarConversionBidireccional() {
        // Arrange
        Usuario usuarioOriginal = Usuario.create(
        ...
        usuarioOriginal.linkDiscord(
                DiscordUserId.of("987654321"),
                DiscordUsername.of("gamer#5678"));
        ...
        assertEquals(usuarioOriginal.getPasswordHash().value(), usuarioReconstruido.getPasswordHash().value());
        assertEquals(usuarioOriginal.getAvatar().url(), usuarioReconstruido.getAvatar().url());
        assertEquals(usuarioOriginal.getDiscordUserId().value(), usuarioReconstruido.getDiscordUserId().value());
        assertEquals(usuarioOriginal.getDiscordUsername().value(),
    ...
    void debeManejarTodosLosEstados() {
        ...
        for (EstadoUsuario estado : EstadoUsuario.values()) {
            ...
            assertEquals(estado, usuario.getStatus(),
    ...
    void debeManejarTodosLosRoles() {
        ...
        for (Rol rol : Rol.values()) {
            ...
            assertEquals(rol, usuario.getRole(),
                    "Rol " + rol.name() + " no se convirtió correctamente");
        }
    }
    ...
    void debeManejarTodosLosIdiomas() {
        ...
        for (Idioma idioma : Idioma.values()) {
            ...
            assertEquals(idioma, usuario.getLanguage(),
