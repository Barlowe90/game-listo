...
class UsuarioFlowIntegrationTest {
        ...
        void flujoCompletoReenviarVerificacion() {
                ...
                CrearUsuarioCommand crearCommand = new CrearUsuarioCommand(
                                ...
                                "Password123!");
                UsuarioDTO usuarioCreado = crearUsuarioUseCase.execute(crearCommand);
                Usuario usuarioOriginal = repositorioUsuarios.findByEmail(Email.of("reenvio@example.com"))
                                .orElseThrow();
                ...
                Usuario usuarioReenviado = repositorioUsuarios.findByEmail(Email.of("reenvio@example.com"))
                                .orElseThrow();
