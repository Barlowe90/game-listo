...
class CambiarCorreoUseCaseTest {
  ...
  void debeLanzarExcepcionSiUsuarioNoExiste() {
    ...
    UsuarioNoEncontradoException exception =
        assertThrows(
            UsuarioNoEncontradoException.class, () -> cambiarCorreoUseCase.execute(command));
  ...
  void debeLanzarExcepcionSiEmailYaRegistrado() {
    ...
    EmailYaRegistradoException exception =
        assertThrows(EmailYaRegistradoException.class, () -> cambiarCorreoUseCase.execute(command));
