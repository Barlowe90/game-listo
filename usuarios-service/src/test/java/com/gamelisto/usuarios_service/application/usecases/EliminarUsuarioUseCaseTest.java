...
class EliminarUsuarioUseCaseTest {
  ...
  @InjectMocks private EliminarUsuarioUseCase eliminarUsuarioUseCase;
  ...
  void debeLanzarExcepcionSiUsuarioNoExiste() {
    ...
    // Act & Assert
    assertThrows(
        UsuarioNoEncontradoException.class, () -> eliminarUsuarioUseCase.execute(usuarioId));
  ...
  void debeEliminarUsuarioEnCualquierEstado() {
    ...
    EstadoUsuario[] estados = {
      EstadoUsuario.PENDIENTE_DE_VERIFICACION, EstadoUsuario.ACTIVO, EstadoUsuario.SUSPENDIDO
    };
    ...
    for (EstadoUsuario estado : estados) {
      ...
      // Assert
      verify(repositorioUsuarios, atLeastOnce())
          .save(argThat(u -> u.getStatus() == EstadoUsuario.ELIMINADO));
    }
  }
