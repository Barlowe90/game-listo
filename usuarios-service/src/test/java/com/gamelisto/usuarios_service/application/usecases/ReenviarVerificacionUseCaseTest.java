...
class ReenviarVerificacionUseCaseTest {
  ...
  void debeLanzarExcepcionSiUsuarioNoExiste() {
    ...
    // Act & Assert
    assertThrows(
        UsuarioNoEncontradoException.class, () -> reenviarVerificacionUseCase.execute(command));
  ...
  void debeLanzarExcepcionSiUsuarioYaEstaActivo() {
    ...
    UsuarioYaVerificadoException exception =
        assertThrows(
            UsuarioYaVerificadoException.class, () -> reenviarVerificacionUseCase.execute(command));
