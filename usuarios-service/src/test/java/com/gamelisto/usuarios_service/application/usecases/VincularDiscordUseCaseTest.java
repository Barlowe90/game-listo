...
class VincularDiscordUseCaseTest {
  ...
  void debeLanzarExcepcionSiUsuarioNoExiste() {
    ...
    // Act & Assert
    assertThrows(UsuarioNoEncontradoException.class, () -> vincularDiscordUseCase.execute(command));
  ...
  void debeLanzarExcepcionSiDiscordYaVinculadoAOtroUsuario() {
    ...
    // Act & Assert
    assertThrows(DiscordYaVinculadoException.class, () -> vincularDiscordUseCase.execute(command));
