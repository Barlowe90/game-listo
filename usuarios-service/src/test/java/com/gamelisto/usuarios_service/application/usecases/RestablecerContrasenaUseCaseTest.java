...
class RestablecerContrasenaUseCaseTest {
    ...
    void debeRestablecerContrasenaExitosamente() {
        ...
        RestablecerContrasenaCommand command = new RestablecerContrasenaCommand(
            token.value(), nuevaContrasena, email
        );
    ...
    void debeLanzarExcepcionSiUsuarioNoExiste() {
        ...
        RestablecerContrasenaCommand command = new RestablecerContrasenaCommand(
            "token", "password", emailInexistente
        );
    ...
    void debeLanzarExcepcionSiTokenEsInvalido() {
        ...
        RestablecerContrasenaCommand command = new RestablecerContrasenaCommand(
            "token_incorrecto", "password", email
        );
    ...
    void debeLanzarExcepcionSiUsuarioNoTieneToken() {
        ...
        RestablecerContrasenaCommand command = new RestablecerContrasenaCommand(
            "cualquier_token", "password", email
        );
