...
class DesvincularDiscordUseCaseTest {
    ...
    void debeLanzarExcepcionSiUsuarioNoExiste() {
        ...
        assertThrows(UsuarioNoEncontradoException.class,
                () -> desvincularDiscordUseCase.execute(usuarioId));
    ...
    void debeFuncionarAunqueDiscordNoVinculado() {
        // Arrange
        Usuario usuarioSinDiscord = Usuario.create(
    ...
    void debeLanzarExcepcionSiIdInvalido() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> desvincularDiscordUseCase.execute(usuarioIdInvalido));
    ...
    void debePermitirReVincularDespuesDeDesvincular() {
        ...
        // Act - Re-vincular
        usuario.linkDiscord(
                DiscordUserId.of("999999999"),
                DiscordUsername.of("newplayer#5555"));
