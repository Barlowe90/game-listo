...
class SolicitarRestablecimientoUseCaseTest {
    ...
    void debeGenerarTokenConExpiracionDeUnaHora() {
        ...
        assertTrue(segundosHastaExpiracion >= 3590 && segundosHastaExpiracion <= 3610,
    ...
    void noDebeLanzarExcepcionCuandoEmailNoExiste() {
        ...
        SolicitarRestablecimientoCommand command = new SolicitarRestablecimientoCommand(emailInexistente);
    ...
    void noDebeRevelarSiEmailEstaRegistrado() {
        ...
        SolicitarRestablecimientoCommand command = new SolicitarRestablecimientoCommand("noexiste@test.com");
