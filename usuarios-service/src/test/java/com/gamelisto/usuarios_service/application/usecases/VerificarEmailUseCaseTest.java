...
class VerificarEmailUseCaseTest {
  ...
  void debeLanzarExcepcionSiTokenNoExiste() {
    ...
    TokenVerificacionInvalidoException exception =
        assertThrows(
            TokenVerificacionInvalidoException.class, () -> verificarEmailUseCase.execute(command));
  ...
  void debeLanzarExcepcionSiUsuarioYaVerificado() {
    ...
    // Act & Assert
    UsuarioYaVerificadoException exception =
        assertThrows(
            UsuarioYaVerificadoException.class, () -> verificarEmailUseCase.execute(command));
  ...
  void debeLanzarExcepcionSiTokenEsNuloOVacio() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> verificarEmailUseCase.execute(commandBlanco));
